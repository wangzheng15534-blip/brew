...
# for bottles) unless there's already a Cellar in HOMEBREW_REPOSITORY. Overlay
# environments always use their own logical Cellar, whose racks point to the
# selected writable or inherited package store.
